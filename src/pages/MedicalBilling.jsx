...
import { Keyboard, MonitorCheck, FileText, ScanSearch, HandCoins, RefreshCcw } from 'lucide-react'
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              ...
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Unleash the Full Potential of Your Revenue! Contact RevTrail Now
                for a Free Consultation. Our expert medical billing team handles
                the complex administrative work so you can focus entirely on
                your patients.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/2.jpg" alt="Medical Billing" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="Medical Billing Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            <h2 style={{
              ...
              Discover The Pinnacle Of Medical Billing Services With RevTrail!
            </h2>
            <p style={{
              ...
              As industry leaders, we combine comprehensive knowledge, advanced technology, and unwavering
              dedication to optimize your revenue cycle. With our team of seasoned experts, your practice
              can enjoy error-free data entry, seamless eligibility verification, efficient claims submission,
              reliable claim scrubbing, meticulous billing and collections, and proactive accounts receivable
              follow-up. Our informative and authoritative approach ensures compliance with industry regulations
              while maximizing reimbursements and reducing claim denials. Partner with RevTrail to unlock your
              practice's financial success and focus on what truly matters: providing exceptional patient care.
            </p>
            <button
              style={{
      ...
      <section style={{ backgroundColor: '#f0f4f9', paddingTop: '80px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '480px', margin: '0 auto' }}>
              Unlock your practice's financial success with our comprehensive billing and collections solutions
            </p>
          </div>
          ...
          <div className="svc-features-grid">
            {[
              {
                icon: <Keyboard size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Error-Free Entry',
                desc: 'Ensure accuracy from the start with our meticulous error-free data entry.',
              },
              {
                icon: <MonitorCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Rejection Management',
                desc: 'We offer rejection management in order to avoid claim rejections and delays.',
              },
              {
                icon: <FileText size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Claims Submission',
                desc: 'Expedite the claims process with our efficient and timely submission services.',
              },
              {
                icon: <ScanSearch size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Reliable Claim Scrubbing',
                desc: 'Rely on our thorough claim scrubbing process for clean and error-free claims.',
              },
              {
                icon: <HandCoins size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Billing And Collections',
                desc: 'Maximize revenue with our comprehensive billing and collections solutions.',
              },
              {
                icon: <RefreshCcw size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'A/R Follow Up',
                desc: 'Stay on top of outstanding claims with our dedicated accounts receivable follow-up.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
          ...
          <div className="svc-stats-grid">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
              <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Snake left */}
                <path d="M33 21 C25 25 24 31 33 33 C42 35 41 41 33 45 C26 48 25 54 30 57"
                  stroke={NAVY} strokeWidth="1.8" strokeLinecap="round" fill="none"/>
                {/* Snake right */}
                <path d="M33 21 C41 25 42 31 33 33 C24 35 25 41 33 45 C40 48 41 54 36 57"
                  stroke={NAVY} strokeWidth="1.8" strokeLinecap="round" fill="none"/>
              </svg>
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail handle your medical billing so you can spend more time with your patients.
          </p>
