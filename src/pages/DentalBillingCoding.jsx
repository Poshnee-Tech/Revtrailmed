...
import { ClipboardList, Target, FileText, MonitorSmartphone, FileWarning, ReceiptText } from 'lucide-react'
...
export default function DentalBillingCoding() {
  return (
    <div>
      <Navbar />
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              <h2 className="svc-hero-heading">
                Maximize Profitability. Prioritize Patient Care.
              </h2>
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Our streamlined processes enable fast claim submission, reducing payment delays and improving cash flow for your dental practice.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/99.jpg" alt="Dental Billing And Coding" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="Dental Billing Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            <h2 style={{
              ...
              Unparalleled Dental Billing And Coding Services
            </h2>
            <p style={{
              ...
              At RevTrail, we specialize in providing comprehensive Dental Billing and Coding Services
              tailored to meet the unique needs of dental practices. Our expert team is well-versed in
              dental insurance verification, ensuring accurate coverage information for each patient.
              We prioritize accurate coding, adhering to industry standards and guidelines to optimize
              reimbursement and minimize claim denials. Our streamlined processes enable fast claim
              submission, reducing payment delays and improving cash flow for your dental practice.
              With our real-time claim tracking system, you can stay updated on the status of your
              claims and monitor revenue trends. We analyze and reverse denials promptly, implementing
              effective strategies to ensure maximum reimbursement. Our dedicated accounts receivable
              follow-up team diligently pursues outstanding balances, reducing your account receivables
              and improving financial performance. Experience the RevTrail advantage in dental billing
              and coding, and let us enhance the revenue potential of your dental practice.
            </p>
            <button
              style={{
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Reduce payment delays and improve cash flow with our streamlined claim submission process.
            </p>
          </div>
          ...
          <div className="svc-features-grid">
            {[
              {
                icon: <ClipboardList size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Dental Insurance Verification',
                desc: 'Accurate verification of dental insurance coverage for each patient.',
              },
              {
                icon: <Target size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Accurate Coding',
                desc: 'Precise coding following industry guidelines for optimized reimbursement.',
              },
              {
                icon: <FileText size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Fast Claim Submission',
                desc: 'Prompt processing and submission of dental claims for accelerated payment.',
              },
              {
                icon: <MonitorSmartphone size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Track Claims In Real-Time',
                desc: 'Real-time claim tracking to monitor the status and progress of claims.',
              },
              {
                icon: <FileWarning size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Analyze And Reverse Denials',
                desc: 'Comprehensive analysis and efficient resolution of claim denials.',
              },
              {
                icon: <ReceiptText size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'A/R Follow Up',
                desc: 'Dedicated accounts receivable follow-up to ensure timely payment and reduce outstanding balances.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          <h2 className="svc-cta-heading">
            Ready To Elevate Your Dental Practice's Revenue?
          </h2>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail's dental billing experts maximize your reimbursements and minimize claim denials for your practice.
          </p>
