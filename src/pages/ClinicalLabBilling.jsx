...
import { CalendarCheck, FileText, MonitorSmartphone, BarChart2, Database, RefreshCcw } from 'lucide-react'
...
export default function ClinicalLabBilling() {
  return (
    <div>
      <Navbar />
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              <h2 className="svc-hero-heading">
                Maximize Claim Acceptance. Minimize Denials.
              </h2>
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                With our accurate coding, timely claim submission, you can enjoy increased cash flow and scale up your business.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/88.jpg" alt="Clinical Lab Billing Services" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="Clinical Lab Billing Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            <h2 style={{
              ...
              Optimize Your Revenue Cycle And Streamline Your Billing Processes
            </h2>
            <p style={{
              ...
              At RevTrail, we specialize in providing comprehensive and efficient Clinical Lab Billing
              Services that optimize your revenue cycle and streamline your billing processes. With our
              extensive expertise and cutting-edge technology, we ensure accurate scheduling and
              eligibility verification, minimizing claim denials and maximizing reimbursement. Our fast
              claim submission process ensures prompt payment processing, accelerating cash flow for
              your clinical lab. Real-time claim tracking allows you to stay updated on the status of
              your claims, while advanced reporting capabilities offer valuable insights into your
              financial performance. We help you keep track of your data, ensuring compliance with
              regulatory requirements and enabling informed decision-making. Our experienced team
              excels in reversing denials and reducing accounts receivable, driving financial success
              for your lab. Rest assured, we maintain strict HIPAA compliance, safeguarding patient
              data confidentiality throughout the billing process. Experience the RevTrail difference
              and unlock your lab's revenue potential.
            </p>
            <button
              style={{
      ...
      <section style={{ backgroundColor: '#f0f4f9', paddingTop: '80px', paddingBottom: '80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Enjoy accelerated cash flow and gain valuable insights into your financial performance through advanced reporting capabilities.
            </p>
          </div>
          ...
          <div className="svc-features-grid">
            {[
              {
                icon: <CalendarCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Scheduling And Eligibility Verification',
                desc: 'Accurate scheduling and verification to minimize claim denials.',
              },
              {
                icon: <FileText size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Claim Submission',
                desc: 'Prompt processing of claims for accelerated cash flow.',
              },
              {
                icon: <MonitorSmartphone size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Track Claims In Real-Time',
                desc: 'Stay updated on the status of your claims with real-time tracking.',
              },
              {
                icon: <BarChart2 size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Advanced Reporting Capabilities',
                desc: 'Gain valuable insights into your financial performance through comprehensive reports.',
              },
              {
                icon: <Database size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Keep Track Of Your Data',
                desc: 'Ensure regulatory compliance and make informed decisions with organized data management.',
              },
              {
                icon: <RefreshCcw size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Reversing Denials',
                desc: 'Expertise in addressing claim denials and optimizing revenue recovery.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
          ...
          <div className="svc-stats-grid">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
              <svg width="66" height="66" viewBox="0 0 66 66" fill="none">
                <path d="M4 38 C4 34 8 30 13 30 L22 30 L26 26 L33 30 L40 26 L44 30 L53 30 C58 30 62 34 62 38 L62 46 C62 52 57 56 51 56 L15 56 C9 56 4 52 4 46 Z" stroke={NAVY} strokeWidth="2" fill="none" strokeLinejoin="round" strokeLinecap="round"/>
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          <h2 className="svc-cta-heading">
            Ready To Streamline Your Lab's Billing?
          </h2>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail's Clinical Lab Billing experts maximize your claim acceptance and accelerate your cash flow.
          </p>
