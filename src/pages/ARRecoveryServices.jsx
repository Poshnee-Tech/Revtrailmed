...
import { ScanSearch, Target, ClipboardList, TrendingUp, HandCoins, Clock } from 'lucide-react'
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              <h2 className="svc-hero-heading">
                Reverse Denials. Increase Revenue.
              </h2>
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Unlock Your Revenue Potential with RevTrail's A/R Recovery Services.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/77.jpg" alt="A/R Recovery Services" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="A/R Recovery Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            ...
            <p style={{
              ...
              At RevTrail, we offer industry-leading A/R Recovery Services designed to optimize your
              revenue cycle and maximize your financial performance. Our team conducts a systematic
              evaluation of your accounts receivable, identifying outstanding balances and unpaid
              claims. With quick and prompt recovery services, we diligently follow up with payers,
              ensuring timely resolution and accelerating cash flow. Our track record of successful
              collection ratios speaks for itself, minimizing bad debts and improving your bottom
              line. We prioritize older unpaid claims, leveraging targeted strategies for higher
              collection potential. Effective patient communication is at the heart of our approach,
              fostering transparent interactions and prompt resolution of outstanding balances.
              Rest assured, we maintain strict HIPAA compliance, safeguarding patient data
              confidentiality. Experience the RevTrail advantage and unlock your revenue potential today.
            </p>
            <button
              style={{
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Minimize bad debts and optimize revenue recovery with our high collection success ratio.
            </p>
          </div>
          ...
          <div className="svc-features-grid">
            {[
              {
                icon: <ScanSearch size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Comprehensive A/R Analysis',
                desc: 'Identify outstanding balances, unpaid claims, and recovery opportunities.',
              },
              {
                icon: <Target size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Proactive Recovery Strategies',
                desc: 'Develop efficient plans for accelerating cash flow and recovering unpaid claims.',
              },
              {
                icon: <ClipboardList size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Persistent Follow-Up',
                desc: 'Consistently engage with payers to expedite payment and resolve outstanding balances.',
              },
              {
                icon: <TrendingUp size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'High Collection Success Ratio',
                desc: 'Maximize reimbursement rates and optimize revenue recovery.',
              },
              {
                icon: <HandCoins size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Bad Debt Reduction',
                desc: 'Minimize financial losses by implementing effective debt reduction strategies.',
              },
              {
                icon: <Clock size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Prioritization Of Aging Claims',
                desc: 'Focus on resolving older unpaid claims for higher collection potential.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail's A/R Recovery team identify unpaid claims and maximize your collections with proven strategies.
          </p>
