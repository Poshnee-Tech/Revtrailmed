          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              ...
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Appointment scheduling is an important component of medical billing, as it helps ensure
                that healthcare providers can effectively manage their patient load and properly bill
                for services rendered. Here are some of the ways in which appointment scheduling is
                integrated into medical billing.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/55.jpg" alt="Appointment Scheduling" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="Appointment Scheduling Dashboard" />
          </div>

          {/* Right: multi-section text */}
          <div className="svc-info-text">

            <div style={{ marginBottom: '28px' }}>
              <h3 style={{ fontFamily: '"Georgia", sans-serif', fontSize: '20px', fontWeight: '700', color: NAVY, marginBottom: '12px', lineHeight: '1.3' }}>
                Patient Registration
              </h3>
              <p style={{ ...PARA }}>
                When a patient schedules an appointment with a healthcare provider, the patient's
                demographic and insurance information is usually collected as part of the registration
                process. This information is important for medical billing purposes, as it helps ensure
                that claims are submitted to the correct payer.
              </p>
            </div>
            ...
            <div style={{ marginBottom: '28px' }}>
              ...
              <p style={{ ...PARA }}>
                If a patient cancels or reschedules an appointment, it is important to update the
                appointment scheduling system and notify the medical billing department of the change.
                This ensures that claims are not submitted for services that were not actually performed.
              </p>
            </div>
            ...
            <div style={{ marginBottom: '32px' }}>
              ...
              <p style={{ ...PARA }}>
                When a patient fails to show up for a scheduled appointment, it can result in lost
                revenue for the healthcare provider. Appointment scheduling can help reduce no-shows
                by sending reminders to patients before their scheduled appointment.
              </p>
            </div>
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Simplify operations and enhance communication with superior client interaction.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Optimize billing processes for maximum revenue and profitability.',
              },
              {
                icon: <Users size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Superior Client Interaction',
                desc: 'Enhance communication and build strong relationships with clients.',
              },
              {
                icon: <ClipboardCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Improved Billing',
                desc: 'Ensure accurate and timely billing to optimize revenue collection.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail integrate appointment scheduling into your billing workflow so no revenue opportunity is missed.
          </p>
