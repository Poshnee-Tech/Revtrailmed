...
import { FileText, UserCheck, ShieldCheck, Activity, HandCoins, BarChart2 } from 'lucide-react'
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              <h2 className="svc-hero-heading">
                Maximize Recoveries. Precise Coding. Reverse Denials.
              </h2>
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Realize Your Revenue Potential with RevTrail's Advanced RCM Solutions.
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/22.jpg" alt="Revenue Cycle Management" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/33.png" alt="RCM Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            <h2 style={{
              ...
              Comprehensive Suite Of Revenue Cycle Management
            </h2>
            <p style={{
              ...
              RevTrail offers a comprehensive suite of revenue cycle management (RCM) solutions designed
              to optimize the financial performance of healthcare providers. With our expertise and
              cutting-edge technology, we provide informative, authoritative, and convincing medical
              billing services. Our dedicated team ensures accurate claim submissions, maximizes
              reimbursement value, and minimizes denials. From eligibility verification and
              pre-authorizations to claims tracking, post-payment collection, and claims analytics,
              we cover every aspect of the revenue cycle. Additionally, our proactive denial alerts
              and management system helps identify and address issues before they impact revenue.
              With RevTrail as your trusted partner, you can rely on detailed performance reporting
              to make informed decisions and achieve sustainable financial success.
            </p>
            <button
              style={{
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Make informed decisions and optimize revenue streams with detailed performance reporting.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Submit Claims At The Highest Value',
                desc: 'Our expertise ensures accurate coding and proper documentation to maximize reimbursement potential.',
              },
              {
                icon: <UserCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Eligibility Verification',
                desc: 'We verify patient insurance coverage to prevent claim denials due to eligibility issues.',
              },
              {
                icon: <ShieldCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Pre-Authorizations',
                desc: 'We handle the pre-authorization process efficiently, reducing claim rejections and delays.',
              },
              {
                icon: <Activity size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Claims Tracking',
                desc: 'Our advanced tracking system allows for real-time visibility into the status of submitted claims.',
              },
              {
                icon: <HandCoins size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Post-Payment Collection',
                desc: 'We employ effective strategies to optimize post-payment collections, reducing outstanding balances.',
              },
              {
                icon: <BarChart2 size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Claims Analytics',
                desc: 'Through comprehensive analytics, we identify trends and patterns to improve billing processes and revenue outcomes.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail handle your revenue cycle management so you can focus on providing excellent patient care.
          </p>
