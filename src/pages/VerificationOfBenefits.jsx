...
import { ClipboardCheck, Target, FileText } from 'lucide-react'
...
export default function VerificationOfBenefits() {
  return (
    <div>
      <Navbar />
          ...
          <div className="svc-hero-row">
            <div className="svc-hero-text">
              <h2 className="svc-hero-heading">
                Maximize Revenue With Eligibility Verification
              </h2>
              <p style={{ ...PARA, color: '#4a5568', marginBottom: '32px', maxWidth: '420px' }}>
                Maximize Reimbursements – Contact RevTrail for Reliable Patient Eligibility Verification Services Today!
              </p>
              <button
                style={{
            ...
            <div className="svc-hero-img-wrap">
              <img src="/images/999.jpg" alt="Insurance Eligibility & Benefits Verification" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#fff', paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={CONTAINER} className="svc-info-row">
          ...
          <div className="svc-info-img-wrap">
            <img src="/images/11.png" alt="Eligibility Verification Dashboard" />
          </div>
          ...
          <div className="svc-info-text">
            <h2 style={{
              ...
              Comprehensive Patient Eligibility Check For Accelerate Cash Flow
            </h2>
            <p style={{
              ...
              At RevTrail, we specialize in providing comprehensive Patient Benefits and Eligibility
              Verification Services to healthcare providers. Our dedicated team understands the
              challenges of claim denials and payment delays that often occur due to incorrect patient
              insurance details. With our expertise in insurance eligibility verification, we help you
              minimize claim denials and expedite payments. By accurately verifying patient eligibility,
              we ensure that you have the necessary information to maximize reimbursements. Our
              streamlined processes and real-time claim tracking system enable you to stay on top of
              the reimbursement process, reducing payment delays and optimizing cash flow. With
              RevTrail by your side, you can focus on providing quality care while we handle the
              complex task of verifying patient eligibility. Trust us to accelerate your revenues,
              eliminate claim denials, and maximize reimbursements through our reliable and efficient
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: '#374151', lineHeight: '1.75', maxWidth: '520px', margin: '0 auto' }}>
              Accelerate cash flow and maximize reimbursements with our reliable eligibility verification services.
            </p>
          </div>
          ...
          <div className="svc-features-grid">
            {[
              {
                icon: <ClipboardCheck size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Insurance Verification',
                desc: 'Thorough verification of insurance benefits to determine coverage details.',
              },
              {
                icon: <Target size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Patient Financial Responsibility',
                desc: "E&B verification involves determining the patient's financial responsibility for the services they are seeking.",
              },
              {
                icon: <FileText size={46} color={NAVY} strokeWidth={1.4} />,
                title: 'Fast Claim Submission',
                desc: 'Expedited claim submission for quicker payment processing.',
              },
            ].map(({ icon, title, desc }) => (
              <div key={title} style={{
                background: '#fff',
      ...
      <section style={{ backgroundColor: NAVY, paddingTop: '72px', paddingBottom: '72px' }}>
        <div style={{ ...CONTAINER, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '15px', color: 'rgba(255,255,255,0.80)', lineHeight: '1.75', maxWidth: '460px', margin: '0 auto 36px' }}>
            Let RevTrail verify patient eligibility accurately and eliminate claim denials to accelerate your revenue.
          </p>
